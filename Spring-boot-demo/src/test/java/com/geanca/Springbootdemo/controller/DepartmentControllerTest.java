...
class DepartmentControllerTest {
    ...
    @BeforeEach
    void setUp(){
        department = Department.builder().departmentAddress("NYC").departmentCode("23232")
                .departmentName("Software Engineering").departmentId(1L).build();
    ...
    void saveDepartment() throws Exception {
        Department inputDepartment = Department.builder().departmentAddress("NYC").departmentCode("23232")
                .departmentName("Software Engineering").build();
